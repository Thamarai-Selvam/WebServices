...
$message = "HELLO THERE !";$result = "";
function MD5C($string){
$a = "67452301";
$b = "EFCDAB89";
$c = "98BADCFE";
$d = "10325476";
...
?>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
            ...
            <input type="text" id="message" name="message" value="<?php echo $message; ?>"><br>
            <input type="submit" value="Submit">
        </form>
        <form class="response_form">
            <label for="response">Checksum</label><br>
            <input type="text" id="response" name="response" value="<?php echo $result; ?>"><br>
        </form>
